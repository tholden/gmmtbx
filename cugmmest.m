...
function [theta_final, S_final, J_test, probJ, bandw, var_theta, std_theta, conf_inter] = ...
    cugmmest(options, data, popmom, startval, lb, ub, nonlcon, varargin)
...
% CU estimator
theta_final = fmincon(@cugobj, startval, [], [], [], [], lb, ub, nonlcon, options, popmom, data, center, method, bandw, varargin{:}); 

...
% CU estimator
theta_final = cmaes(@(XV) parallel_wrapper( @(X) gobj(X, popmom, data, center, method, bandw, varargin{:}) + 1e12 * sum( max( 0, nonlcon(X, popmom, data, center, method, bandw, varargin{:}) ) ), XV ), startval, sigma, options ); 
